...
4. Prepare, don't execute: draft the branch name, commit message and PR body,
   then hand the user the exact commands. Git state is theirs to change, and the
   guard hook denies agent-run git writes.
5. No AI/LLM attribution anywhere in the commit message or the PR body.
